...
ADMINS = {'jserrino', 'nilai', 'davidja', 'glram', 'sotremba', 'shreyass', 'andyzhu', 'haijiaw', 'mattmcm', 'scyang', 'garrud4', 'maxt114', 'gaurabd', 'alexyz', 'dylanrd', 'srisar', 'sejalr', 'samtzhou', 'stevez', 'bcostin', 'mgao7', 'reesel', 'lzsims', 'alanduan'}
